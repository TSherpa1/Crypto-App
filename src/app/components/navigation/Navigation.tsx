...
import SearchBar from "./navigationComponents/SearchBar/SearchBar";
        ...
        >
          ...
          <defs>
            <clipPath id="clip0_587_3440">
              <rect width="36" height="20" fill="white" fillOpacity={1} />
            </clipPath>
          </defs>
        </svg>
        <p className="text-l font-semibold relative bottom-1">Logoipsm</p>
      </div>
